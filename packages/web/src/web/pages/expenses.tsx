        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-4">
            <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto" style={{ background: SURF, border: `2px dashed ${BORD}` }}>
              <Receipt size={32} style={{ color: DIM }} />
            </div>
            <div>
              <div className="font-semibold text-sm" style={{ color: TEXT }}>Expense Tracking</div>
              <div className="text-xs mt-1" style={{ color: DIM }}>Coming soon — log daily expenses,<br />categorize costs, and track spending.</div>
            </div>
